...
summary: "A population-adjusted planning dashboard that helps compare county healthcare indicators and identify service gaps."
...
repository: "https://github.com/arapkirui513-hub/kenya-health-dashboard"
demo: "https://kenya-health-dashboard.vercel.app"

status: Completed

readingTime: "7 min"

featuredImage: "/images/og/kenya-health-dashboard.jpg"
ogImage: "/images/og/kenya-health-dashboard.jpg"
---
...
<Figure
  src="/images/case-studies/kenya-dashboard-overview.png"
  alt="Kenya Health Facilities Dashboard overview"
  caption="The production dashboard brings healthcare access, county indicators, and planning signals into a unified county-level planning interface."
  width={1896}
  height={882}
/>
...
<Figure
  src="/images/case-studies/kenya-health-need-index.png"
  alt="Kenya Health Facilities Dashboard Health Need Index"
  caption="The Health Need Index presents a transparent county-level health-need signal alongside the broader planning indicators."
  width={1896}
  height={880}
/>
...
<Figure
  src="/images/case-studies/kenya-county-comparison.png"
  alt="Kenya Health Facilities Dashboard county comparison"
  caption="The County Explorer supports side-by-side comparison of county healthcare indicators within the same planning workflow."
  width={1896}
  height={879}
/>
